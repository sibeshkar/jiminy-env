...
func NewEnvState(EnvId string, EnvStatus string, EpisodeId float32, Fps float32) (*EnvState, error) {
...
func (e *EnvState) SetEpisodeId(EpisodeId float32) bool {
	e.Lock()
	defer e.Unlock()
...
func (e *EnvState) GetEpisodeId() float32 {
	e.Lock()
	defer e.Unlock()
	return e.EpisodeId
}
